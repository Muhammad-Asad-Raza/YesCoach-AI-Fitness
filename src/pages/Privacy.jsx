    ...
    <div className="page-container privacy-page">
      <div className="inner-page" style={{maxWidth: '780px'}}>
        ...
        <div className="legal-content">
          ...
          <p>YesCoach collects information you provide directly to us, including when you create an account, use our AI coach, or contact support. This includes your name, email address, fitness goals, training history, and health metrics you manually provide such as HRV, sleep data, and heart rate.</p>
