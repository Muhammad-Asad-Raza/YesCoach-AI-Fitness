    ...
    <div className="page-container features-page">
      <div className="inner-page">
        ...
        <div className="feat-big-grid">
          ...
          <div className="feat-big-card reveal reveal-delay-1"><span className="feat-big-icon">💓</span><h3>Daily Readiness Scoring</h3><p>Input your daily metrics to get an instant readiness score. Your recovery level drives every training decision automatically to prevent overtraining.</p><ul className="feat-list"><li>Manual biometric logging</li><li>Daily readiness scoring</li><li>Auto volume adjustment</li><li>7-day trend analysis</li></ul></div>
