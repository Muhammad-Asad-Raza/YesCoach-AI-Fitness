  ...
  const faqs = [
    {
      ...
      a: "Every morning, YesCoach analyzes your reported sleep quality, resting heart rate and body temperature. If recovery metrics are below your personal baseline, the AI automatically reduces session volume or intensity for that day. You can also trigger adjustments manually by telling the AI how you feel in the chat."
    },
    {
      q: "Can I use YesCoach without a wearable?",
      a: "Absolutely. YesCoach is designed to be fully functional with or without a wearable. The AI uses your daily check-ins (energy, mood, soreness) and manual logs to make precise adjustments to your plan."
    },
    {
    ...
    <div className="page-container help-page">
      <div className="inner-page">
        ...
        <div className="help-cats reveal">
          <div className="help-cat"><div className="help-cat-icon">📱</div><h3>Getting Started</h3><p>Set up your account, choose your goals and get your first plan.</p></div>
